...
//body parser
app.use(cors({
  origin:['http://localhost:3000','http://10.0.70.92:3000','http://10.0.70.92:5173','https://mithila.binarybards.online','https://e335-115-127-157-41.ngrok-free.app','http://31.97.171.35:4173'],
  credentials:true,
}));
